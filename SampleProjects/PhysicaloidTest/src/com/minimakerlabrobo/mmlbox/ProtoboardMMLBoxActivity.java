package com.minimakerlabrobo.mmlbox;
...
public class ProtoboardMMLBoxActivity extends Activity {
   ...
   float my;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protoboard_mmlbox);
        ...
        String uri = "@drawable/"+ activityBoxValue.getDirectory().toLowerCase()+"_mml_box";  // where myresource (without the extension) is the file
       ...
       buttonNext.setText(getResources().getText(R.string.buttonNext));
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 Intent iuploadHexActivity = new Intent(ProtoboardMMLBoxActivity.this,UploadHexActivity.class);

                iuploadHexActivity.putExtra("file",ProtoboardMMLBoxActivity.this.file);
